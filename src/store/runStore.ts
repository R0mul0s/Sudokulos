...
export const useRunStore = create<RunStore>()(
  persist(
    ...
    }),
    {
      ...
      migrate: (persisted) => {
        // Defenzivně sjednotíme levelState s INITIAL_LEVEL_STATE pro libovolnou
        // verzi, aby případná chybějící pole (přidaná po vydání) nezpůsobila
        // runtime undefined access. Spouští se při version mismatch.
